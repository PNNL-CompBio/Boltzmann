...
int print_concs_dconcs(struct state_struct *state,int ny,
		       double *dconcs, 
		       double *concs, 
		       double time, 
		       double h,
		       ...
		       int    origin) {
/* 
  Debugging routine to print concentrations and delta concentrations, dconcs,
  for each molecule.
  Called by: ode23tb 
