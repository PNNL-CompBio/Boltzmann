...
int boltzmann_save_aux_data(struct state_struct *state, void **aux_data_p) {
  /*
    Create a contiguous copy of strings in the boltzman state struct.
