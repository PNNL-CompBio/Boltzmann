...
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"sss\" -DPACKAGE_TARNAME=\"sss\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"sss\ 0.1\" -DPACKAGE_BUGREPORT=\"douglas.baxter@pnnl.gov\" -DPACKAGE=\"sss\" -DVERSION=\"0.1\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
OBJEXT = o
PACKAGE = sss
PACKAGE_BUGREPORT = douglas.baxter@pnnl.gov
PACKAGE_NAME = sss
...
# NB SUNDIALS_ROOT here defined instead of in Makefile.head as it gets
# defined differently in the sundials Makefiles which include Makefile.head
...
SERIAL_OBJS7 = deq_run.o alloc7.o ode_solver.o ode23tb.o \
	...
	lr13_approximate_delta_concs.o lr14_approximate_delta_concs.o \
...
am--refresh:
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/Makefile.body $(srcdir)/Makefile.head $(am__configure_deps)
	@for dep in $?; do \
...
libboltzmann.a: $(SERIAL_OBJS1)  $(SERIAL_OBJS2) $(SERIAL_OBJS3) $(SBML_OBJS) $(KFM_OBJS) $(KFP_OBJS) $(KPM_OBJS) $(SERIAL_OBJS7) $(SERIAL_OBJS8) bwarmup_run.o
	...
	$(AR) $(ARFLAGS) libboltzmann.a alloc8.o
	$(AR) $(ARFLAGS) libboltzmann.a alloc9.o
	$(AR) $(ARFLAGS) libboltzmann.a print_reactions_matrix.o
	$(AR) $(ARFLAGS) libboltzmann.a print_active_reactions_matrix.o
	...
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_load_agent_data.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_build_agent_data_block.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_save_agent_data.o
	...
	$(AR) $(ARFLAGS) libboltzmann.a bwarmup_run.o
	$(AR) $(ARFLAGS) libboltzmann.a alloc7.o
	$(AR) $(ARFLAGS) libboltzmann.a ode_print_concs_header.o
	$(AR) $(ARFLAGS) libboltzmann.a ode_print_dconcs_header.o
	...
	$(AR) $(ARFLAGS) libboltzmann.a get_counts.o
	$(AR) $(ARFLAGS) libboltzmann.a ode_test_steady_state.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_monitor_ode.o
	$(AR) $(ARFLAGS) libboltzmann.a print_dense_jacobian.o
	$(AR) $(ARFLAGS) libboltzmann.a print_sparse_jacobian.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_cvodes.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_size_jacobian.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_cvodes_rhs.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_print_cvodeinit_errors.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_cvodes_init.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_check_cvodeset_errors.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_check_tol_errors.o
	...
	$(AR) $(ARFLAGS) libboltzmann.a precondition_newton_matrix.o
	$(AR) $(ARFLAGS) libboltzmann.a iluvf.o
	$(AR) $(ARFLAGS) libboltzmann.a dcrsng_mag_sort.o
	$(AR) $(ARFLAGS) libboltzmann.a dcrsng_mag_merge.o
	$(AR) $(ARFLAGS) libboltzmann.a isort.o
	$(AR) $(ARFLAGS) libboltzmann.a imerge.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_cvodes_psolve.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_cvodes_bsolve.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_cvodes_fsolve.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_cvodes_jtimes.o
	$(AR) $(ARFLAGS) libboltzmann.a boltzmann_sparse_mvp.o
	...
	$(AR) $(ARFLAGS) libboltzmann.a dgbtrf.o
	$(AR) $(ARFLAGS) libboltzmann.a dgbtf2.o
	$(AR) $(ARFLAGS) libboltzmann.a dger.o
	$(AR) $(ARFLAGS) libboltzmann.a dgbtrs.o
	$(AR) $(ARFLAGS) libboltzmann.a dswap.o
	$(AR) $(ARFLAGS) libboltzmann.a dtbsv.o
	$(AR) $(ARFLAGS) libboltzmann.a ode_num_jac.o
	$(AR) $(ARFLAGS) libboltzmann.a compute_flux_scaling.o
	$(AR) $(ARFLAGS) libboltzmann.a approximate_delta_concs.o
	...
	$(AR) $(ARFLAGS) libboltzmann.a lr4_approximate_delta_concs.o
	...
	$(AR) $(ARFLAGS) libboltzmann.a lr13_approximate_delta_concs.o
	$(AR) $(ARFLAGS) libboltzmann.a lr14_approximate_delta_concs.o
...
boltzmann: boltzmann.o libboltzmann.a $(SUNDIALS_LIBS)
	$(CLINKER) $(LFLAGS) -o boltzmann boltzmann.o $(SERIAL_OBJS1) $(SERIAL_OBJS2) $(SERIAL_OBJS3) $(SBML_OBJS) $(SERIAL_OBJS7) $(SERIAL_OBJS8) $(LIBS)

boltzmann.o: $(SERIAL_INCS) boltzmann.c boltzmann_init.h boltzmann_run.h 
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann.c

deq: deq.o libboltzmann.a $(SUNDIALS_LIBS)
	$(CLINKER) $(LFLAGS) -o deq deq.o $(SERIAL_OBJS1) $(SERIAL_OBJS2) $(SERIAL_OBJS3) $(SBML_OBJS) $(SERIAL_OBJS7) $(SERIAL_OBJS8) $(LIBS)

bwarmup: bwarmup.o libboltzmann.a $(SUNDIALS_LIBS)
	$(CLINKER) $(LFLAGS) -o bwarmup bwarmup.o $(SERIAL_OBJS1) $(SERIAL_OBJS2) $(SERIAL_OBJS3) $(SBML_OBJS) bwarmup_run.o $(SERIAL_OBJS7) $(SERIAL_OBJS8) $(LIBS) 
...
echo_inputs.o: $(SERIAL_INCS) echo_inputs.c echo_inputs.h echo_params.h echo_reactions_file.h print_molecules_dictionary.h print_dg0_ke.h print_counts.h 
...
run_init.o: $(SERIAL_INCS) run_init.c run_init.h vgrng_init.h print_rxn_likelihoods_header.h print_free_energy_header.h alloc8.h alloc9.h print_reactions_matrix.h print_active_reactions_matrix.h
...
alloc8.o: $(SERIAL_INCS) alloc8.c alloc8.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c alloc8.c

alloc9.o: $(SERIAL_INCS) alloc9.c alloc9.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c alloc9.c
...
print_active_reactions_matrix.o: $(SERIAL_INCS) print_active_reactions_matrix.c print_active_reactions_matrix.h zero_solvent_coefficients.h recover_solvent_coefficients.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c print_active_reactions_matrix.c

boltzmann_run.o: $(SERIAL_INCS) boltzmann_run.c boltzmann_run.h update_rxn_log_likelihoods.h choose_rxn.h compute_delta_g_forward_entropy_free_energy.h print_rxn_choice.h print_counts.h boltzmann_watch.h print_boundary_flux.h print_restart_file.h print_reactions_view.h deq_run.h vec_set_constant.h blas.h boltzmann_load_agent_data.h boltzmann_save_agent_data.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_run.c

boltzmann_load_agent_data.o: boltzmann_load_agent_data.c boltzmann_load_agent_data.h $(SERIAL_INCS) boltzmann_flatten_vgrng_state.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_load_agent_data.c

boltzmann_save_agent_data.o: boltzmann_save_agent_data.c boltzmann_save_agent_data.h $(SERIAL_INCS) boltzmann_flatten_vgrng_state.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_save_agent_data.c

boltzmann_build_agent_data_block.o: boltzmann_build_agent_data_block.c boltzmann_build_agent_data_block.h $(SERIAL_INCS) boltzmann_save_agent_data.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_build_agent_data_block.c
...
sbml2bo: sbml2bo.o libboltzmann.a 
	$(CLINKER) $(LFLAGS) -o sbml2bo sbml2bo.o $(SERIAL_OBJS1) $(SERIAL_OBJS2) $(SERIAL_OBJS3) $(SBML_OBJS) $(SERIAL_OBJS7) $(SERIAL_OBJS8) $(LIBS)
...
bwarmup.o : bwarmup.c $(SERIAL_INCS) boltzmann_init.h bwarmup_run.h 
	$(CC) $(DCFLAGS) $(TFLAGS) -c bwarmup.c

deq_run.o: deq_run.c deq_run.h $(SERIAL_INCS) alloc7.h init_base_reactants.h init_relative_rates.h ode_solver.h ode_print_concs_header.h ode_print_dconcs_header.h ode_print_lklhd_header.h ode_print_bflux_header.h print_net_lklhd_bndry_flux_header.h print_net_likelihood_header.h get_counts.h
...
ode_print_dconcs_header.o: ode_print_dconcs_header.c ode_print_dconcs_header.h $(SERIAL_INCS) 
	$(CC) $(DCFLAGS) $(TFLAGS) -c ode_print_dconcs_header.c
...
boltzmann_monitor_ode.o: boltzmann_monitor_ode.c boltzmann_monitor_ode.h $(SERIAL_INCS) ode_print_concs.h get_counts.h update_rxn_likelihoods.h ode_print_lklhds.h approximate_delta_concs.h ode_print_dconcs.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_monitor_ode.c

print_dense_jacobian.o: print_dense_jacobian.c print_dense_jacobian.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c print_dense_jacobian.c

print_sparse_jacobian.o: print_sparse_jacobian.c print_sparse_jacobian.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c print_sparse_jacobian.c
...
compute_net_lklhd_bndry_flux.o: compute_net_lklhd_bndry_flux.c compute_net_lklhd_bndry_flux.h $(SERIAL_INCS) 
	$(CC) $(DCFLAGS) $(TFLAGS) -c compute_net_lklhd_bndry_flux.c

print_net_likelihood_header.o: print_net_likelihood_header.c print_net_likelihood_header.h $(SERIAL_INCS) 
	$(CC) $(DCFLAGS) $(TFLAGS) -c print_net_likelihood_header.c 

print_net_lklhd_bndry_flux_header.o: print_net_lklhd_bndry_flux_header.c print_net_lklhd_bndry_flux_header.h $(SERIAL_INCS) 
	$(CC) $(DCFLAGS) $(TFLAGS) -c print_net_lklhd_bndry_flux_header.c

print_net_likelihoods.o: print_net_likelihoods.c print_net_likelihoods.h $(SERIAL_INCS) 
	$(CC) $(DCFLAGS) $(TFLAGS) -c print_net_likelihoods.c 

print_net_lklhd_bndry_flux.o: print_net_lklhd_bndry_flux.c print_net_lklhd_bndry_flux.h $(SERIAL_INCS) 
	$(CC) $(DCFLAGS) $(TFLAGS) -c print_net_lklhd_bndry_flux.c

init_base_reactants.o: init_base_reactants.c init_base_reactants.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c init_base_reactants.c

init_relative_rates.o: init_relative_rates.c init_relative_rates.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c init_relative_rates.c
...
ce_approximate_delta_concs.o: ce_approximate_delta_concs.c ce_approximate_delta_concs.h update_rxn_likelihoods.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c ce_approximate_delta_concs.c 

lr_approximate_delta_concs.o: lr_approximate_delta_concs.c lr_approximate_delta_concs.h compute_flux_scaling.h update_rxn_likelihoods.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c lr_approximate_delta_concs.c 

lr1_approximate_delta_concs.o: lr1_approximate_delta_concs.c lr1_approximate_delta_concs.h compute_flux_scaling.h update_rxn_likelihoods.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c lr1_approximate_delta_concs.c 

lr2_approximate_delta_concs.o: lr2_approximate_delta_concs.c lr2_approximate_delta_concs.h compute_flux_scaling.h update_rxn_likelihoods.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c lr2_approximate_delta_concs.c 

lr3_approximate_delta_concs.o: lr3_approximate_delta_concs.c lr3_approximate_delta_concs.h compute_flux_scaling.h update_rxn_likelihoods.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c lr3_approximate_delta_concs.c 

lr4_approximate_delta_concs.o: lr4_approximate_delta_concs.c lr4_approximate_delta_concs.h compute_flux_scaling.h update_rxn_likelihoods.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c lr4_approximate_delta_concs.c 

lr5_approximate_delta_concs.o: lr5_approximate_delta_concs.c lr5_approximate_delta_concs.h compute_flux_scaling.h update_rxn_likelihoods.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c lr5_approximate_delta_concs.c 
...
lr13_approximate_delta_concs.o: lr13_approximate_delta_concs.c lr13_approximate_delta_concs.h get_counts.h update_regulations.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c lr13_approximate_delta_concs.c 

lr14_approximate_delta_concs.o: lr14_approximate_delta_concs.c lr14_approximate_delta_concs.h get_counts.h update_regulations.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c lr14_approximate_delta_concs.c 
...
num_jac_col.o: num_jac_col.c num_jac_col.h $(SERIAL_INCS) approximate_delta_concs.h 
	$(CC) $(DCFLAGS) $(TFLAGS) -c num_jac_col.c 

ode_it_solve.o: ode_it_solve.c ode_it_solve.h $(SERIAL_INCS) approximate_delta_concs.h 
...
boltzmann_cvodes.o: boltzmann_cvodes.c boltzmann_cvodes.h $(SERIAL_INCS) boltzmann_size_jacobian.h boltzmann_cvodes_rhs.h boltzmann_print_cvodeinit_errors.h boltzmann_cvodes_init.h boltzmann_print_cvode_error.h boltzmann_monitor_ode.h boltzmann_print_sensitivities.h ode_test_steady_state.h
...
boltzmann_size_jacobian.o: boltzmann_size_jacobian.c boltzmann_size_jacobian.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_size_jacobian.c

boltzmann_cvodes_rhs.o: boltzmann_cvodes_rhs.c boltzmann_cvodes_rhs.h $(SERIAL_INCS) approximate_delta_concs.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_cvodes_rhs.c
...
boltzmann_check_cvodeset_errors.o: boltzmann_check_cvodeset_errors.c boltzmann_check_cvodeset_errors.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_check_cvodeset_errors.c

boltzmann_check_tol_errors.o: boltzmann_check_tol_errors.c boltzmann_check_tol_errors.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_check_tol_errors.c

boltzmann_set_cvodes_linear_solver.o: boltzmann_set_cvodes_linear_solver.c boltzmann_set_cvodes_linear_solver.h $(SERIAL_INCS) boltzmann_check_cvdls_errors.h boltzmann_check_cvspils_errors.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_set_cvodes_linear_solver.c

boltzmann_check_cvdls_errors.o: boltzmann_check_cvdls_errors.c boltzmann_check_cvdls_errors.h $(SERIAL_INCS) 
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_check_cvdls_errors.c
...
approximate_jacobian.o: approximate_jacobian.c approximate_jacobian.h $(SERIAL_INCS) ode_num_jac.h lr8_approximate_jacobian.h boltzmann_sparse_to_dense.h boltzmann_dense_to_sparse.h print_sparse_jacobian.h
...
crs_column_sort_rows.o: crs_column_sort_rows.c crs_column_sort_rows.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c crs_column_sort_rows.c

build_newton_matrix.o: build_newton_matrix.c build_newton_matrix.h $(SERIAL_INCS) 
	$(CC) $(DCFLAGS) $(TFLAGS) -c build_newton_matrix.c

precondition_newton_matrix.o: precondition_newton_matrix.c precondition_newton_matrix.h $(SERIAL_INCS) iluvf.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c precondition_newton_matrix.c

iluvf.o: iluvf.c iluvf.h $(SERIAL_INCS) dcrsng_mag_sort.h isort.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c iluvf.c

dcrsng_mag_sort.o: dcrsng_mag_sort.c dcrsng_mag_sort.h $(SERIAL_INCS) dcrsng_mag_merge.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c dcrsng_mag_sort.c

dcrsng_mag_merge.o: dcrsng_mag_merge.c dcrsng_mag_merge.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c dcrsng_mag_merge.c

isort.o: isort.c isort.h $(SERIAL_INCS) imerge.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c isort.c

imerge.o: imerge.c imerge.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c imerge.c

boltzmann_cvodes_psolve.o: boltzmann_cvodes_psolve.c boltzmann_cvodes_psolve.h $(SERIAL_INCS)  boltzmann_cvodes_bsolve.h boltzmann_cvodes_fsolve.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_cvodes_psolve.c

boltzmann_cvodes_bsolve.o: boltzmann_cvodes_bsolve.c boltzmann_cvodes_bsolve.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_cvodes_bsolve.c

boltzmann_cvodes_fsolve.o: boltzmann_cvodes_fsolve.c boltzmann_cvodes_fsolve.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_cvodes_fsolve.c

boltzmann_cvodes_jtimes.o: boltzmann_cvodes_jtimes.c boltzmann_cvodes_jtimes.h $(SERIAL_INCS) approximate_jacobian.h boltzmann_sparse_mvp.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_cvodes_jtimes.c
...
dgbtrf.o: dgbtrf.c dgbtrf.h $(SERIAL_INCS) blas.h dgbtf2.h dlaswp.h dger.h dgemm.h dtrsm.h
	 $(CC) $(DCFLAGS) $(TFLAGS) -c dgbtrf.c

dgbtf2.o: dgbtf2.c dgbtf2.h $(SERIAL_INCS) blas.h dswap.h dger.h
	 $(CC) $(DCFLAGS) $(TFLAGS) -c dgbtf2.c

dger.o: dger.c dger.h $(SERIAL_INCS) 
	 $(CC) $(DCFLAGS) $(TFLAGS) -c dger.c

dgbtrs.o: dgbtrs.c dgbtrs.h $(SERIAL_INCS) blas.h dger.h dswap.h dtbsv.h
	 $(CC) $(DCFLAGS) $(TFLAGS) -c dgbtrs.c

dswap.o: dswap.c dswap.h $(SERIAL_INCS) 
	 $(CC) $(DCFLAGS) $(TFLAGS) -c dswap.c

dtbsv.o: dtbsv.c dtbsv.h $(SERIAL_INCS) lsame.h
	 $(CC) $(DCFLAGS) $(TFLAGS) -c dtbsv.c
