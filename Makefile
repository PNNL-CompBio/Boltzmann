...
libboltzmann.a: $(SERIAL_OBJS1)  $(SERIAL_OBJS2) $(SERIAL_OBJS3) $(SERIAL_OBJS4) $(SBML_OBJS) $(KFM_OBJS) $(KFP_OBJS) $(KPM_OBJS) $(SERIAL_OBJS7) $(SERIAL_OBJS8) $(SAVE_LOAD_OBJS) bwarmup_run.o
...
#print_concs.o: $(SERIAL_INCS) print_concs.c print_concs.h
#	$(CC) $(DCFLAGS) $(TFLAGS) -c print_concs.c
...
#boltzmann_set_cvodes_linear_solver.o: boltzmann_set_cvodes_linear_solver.c boltzmann_set_cvodes_linear_solver.h $(SERIAL_INCS) boltzmann_check_cvdls_errors.h boltzmann_check_cvsls_errors.h boltzmann_check_cvspils_errors.h
...
#boltzmann_check_cvsls_errors.o: boltzmann_check_cvsls_errors.c boltzmann_check_cvsls_errors.h $(SERIAL_INCS) 
#	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_check_cvsls_errors.c
...
boltzmann_test_save_load.o: boltzmann_test_save_load.c $(SERIAL_INCS) boltzmann_init.h boltzmann_save_state.h boltzmann_save_aux_data.h boltzmann_load_state.h boltzmann_load_aux_data.h open_output_files.h boltzmann_free_state.h
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_test_save_load.c

boltzmann_free_state.o: boltzmann_free_state.c boltzmann_free_state.h $(SERIAL_INCS)
	$(CC) $(DCFLAGS) $(TFLAGS) -c boltzmann_free_state.c

boltzmann_save_state.o: boltzmann_save_state.c boltzmann_save_state.h $(SERIAL_INCS) boltzmann_flatten_state.h boltzmann_build_agent_data_block.h
...
boltzmann_load_state.o: boltzmann_load_state.c boltzmann_load_state.h $(SERIAL_INCS) boltzmann_flatten_state.h boltzmann_build_agent_data_block.h
