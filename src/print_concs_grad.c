...
int print_concs_grad(struct state_struct *state,int ny,
		       double *grad, 
		       double *concs, 
		       double time, 
		       double h,
		       ...
		       int    origin) {
/* 
  Debugging routine to print concentrations and concentrations gradient, grad,
  for each molecule.
  Called by: ode23tb 
